...
export class PaiementController {
  ...
  async debitPayment(
    ...
    return await this.paiementService.paymentDebit(
      payload.paiement,
      payload.transaction,
      payload.historique,
      payload.amount,
  ...
  async execPayment(
    ...
    return await this.paiementService.sendPayment(
      payload.senderInfos,
      payload.reservation,
      payload.receiverNumber,
      payload.amount,
  ...
  async getAllPendingPaymentForAMerchant(
    ...
    return await this.paiementService.getAllPendingPaymentForAMerchant(
      receiverPhoneNumber,
    );
  }
