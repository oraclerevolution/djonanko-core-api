...
export class TransfertService {
  constructor(
    ...
    private readonly repository: Repository<Transfert>,
      ...
      if (debit.affected === 1) {
        ...
        if (credit) {
          ...
          await this.notificationsService.sendNotification(
            ...
            'Transfert Djonanko',
            `${getReceiverInfos.fullname} vous a transferé ${amount} FCFA`,
          );
        } else {
          return {
  ...
  async getTransferByReceiverNumber(
