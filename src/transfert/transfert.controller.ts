...
export class TransfertController {
  ...
  @Post('initTransfer')
  async initTransfer(@Body() payload: MakeTransfertDto) {
  ...
  async debitTransfer(
    ...
    return await this.transfertService.transferDebit(
      payload.transfer,
      payload.transaction,
      payload.historique,
      payload.amount,
  ...
  async execTransfer(
    ...
    return await this.transfertService.sendTransfer(
      payload.reservation,
      payload.receiverNumber,
      payload.amount,
      payload.transfer,
  ...
  async getTransferByReference(@Query('reference') reference: string) {
